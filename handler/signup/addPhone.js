...
const addPhone = (req, res, options = {}, k, key, iv) => {
    ...
    lock(k, key, phone, iv).then(() => {
        connection.query(`INSERT INTO BJS_SIGNUP(id, fName, lName, phone, password, captcha, agreement, confirm, pContact, pContact_email, otp, hash, gender, expertise) VALUES('${id_e}', '${fName_e}', '${lName_e}', '${phone_e}', '${password_e}', '${Captcha_e}', '${agreement_e}', '${confirm_e}', '${pContact_e}', '${pContact_email_e}', '${otp_e}', '${hash_e}', '${gender_e}', '${expertise_e}')`, function (e, r, f) {
            if (!e) {
                const d = {
                    data: "done",
                    token: hash
